    ...
    <div class="bg-[#1B1C1F] text-white mt-12 p-4 rounded-t-md">
        <div class="sm:text-7xl text-6xl font-bold flex flex-col justify-center h-screen items-center text-center bg-[#3C3E44] rounded-md" id="timer">
            ...
            <div class="flex items-center justify-center space-x-3">
                ...
                <svg class="bg-[#2B2D31] rounded-full p-2 mt-10 cursor-pointer" @click="startTimer()" xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" style="fill: rgba(255, 255, 255, 1);transform: ;msFilter:;"><path d="M7 6v12l10-6z"></path></svg>
